...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT( //Alphabet
		...
		KC_SCLN, KC_SLSH, KC_Z, KC_X, KC_C, KC_V, KC_B,                 KC_N, KC_M, KC_COMM, KC_DOT, KC_UP,
		KC_LALT, KC_LGUI, KC_LCTL, MO(2), KC_LSFT,                      KC_SPC, MO(1), KC_LEFT, KC_RGHT, KC_DOWN, XXXXXXX, XXXXXXX), 
	...
	[1] = LAYOUT( //Numpad and Punctuation                            
		...
		KC_QUOT, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_UNDS, KC_MINS,  KC_PLUS, KC_EQL, KC_PIPE, KC_BSLS, KC_PGUP,  
		KC_LALT, KC_LGUI, KC_LCTL, LGUI(KC_SPC), KC_LSFT,               KC_CAPS, TO(0), KC_HOME, KC_END, KC_PGDN, XXXXXXX, XXXXXXX), 
	...
	[2] = LAYOUT( //Punctuation and Arrow key                         
		...
		KC_LALT, KC_LGUI, KC_LCTL, TO(0), KC_LSFT,                      KC_INS, KC_NUM, KC_PAUS, KC_PSCR, KC_SCRL, XXXXXXX, XXXXXXX), 
